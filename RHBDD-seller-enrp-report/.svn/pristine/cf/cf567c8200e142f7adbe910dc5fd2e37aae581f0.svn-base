...
public class EnrpSellerBlock1Data {
	...
	public String toString() {
		...
		Formatter format=new Formatter(bd);
		format.format("%-5s%-8s%-10s%-8s%-40s%-20s%-1s%-20s%-54s%-20s%-18s%-2s%-3s%-2s%-27s%-11s%-27s%-8s%-8s%-8s%-8s%-2s%-25s", serialNO,sellerBankId,sellerId,buyerBankId,batchId,paymentRefNo,identificationType,identificationNo,customerName,accountNo,maxDebitAmount,freqMode,maxFreq,typeOfApplication,paymentPurpose,
